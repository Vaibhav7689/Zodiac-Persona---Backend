"""
Data models for zodiac_persona library.
...
from zodiac_persona.core.constants import ZODIAC_SIGNS, MIN_REQUIRED_SHADBALA
...
class VedicBirthChart:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            "@context": "https://zodiac_persona.org/vocab/v1.jsonld",
