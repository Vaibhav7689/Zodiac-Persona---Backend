"""
Astronomical calculations for zodiac_persona.
...
from zodiac_persona.core.models import Person, Ayanamsa as AyanamsaModel, PlanetPosition, PlanetDignities
...
def _get_data_directory():
    ...
    if system == "Windows":
        ...
        data_dir = os.path.join(base_dir, 'zodiac_persona')
    elif system == "Darwin":  # macOS
        # Use Application Support on macOS
        data_dir = os.path.expanduser('~/Library/Application Support/zodiac_persona')
    else:  # Linux and other Unix-like systems
        # Use XDG Base Directory specification
        xdg_data = os.environ.get('XDG_DATA_HOME', os.path.expanduser('~/.local/share'))
        data_dir = os.path.join(xdg_data, 'zodiac_persona')
