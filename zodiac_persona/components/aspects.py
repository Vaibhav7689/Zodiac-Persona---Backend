"""
Aspects component for zodiac_persona library.
...
from zodiac_persona.core.models import PlanetPosition, Aspect, House
from zodiac_persona.core.constants import ZODIAC_SIGNS
