"""
Strength calculations (Bala) for zodiac_persona library, modern-adapted from PyJHora.
...
from zodiac_persona.core.constants import (
...
from zodiac_persona.core.models import RasiChart, Person
from zodiac_persona.core.astronomical import skyfield_time_from_datetime, get_planet_declination, get_planet_velocity, get_solar_ingress_weekday


# Use global Skyfield objects from core.astronomical
from zodiac_persona.core.astronomical import get_timescale, get_ephemeris
...
def compute_nathonnatabala(chart: RasiChart, person: Person) -> None:
    from zodiac_persona.core.astronomical import get_sunrise_sunset
...
def compute_chestagbala(chart: RasiChart, person: Person) -> None:
    ...
    from zodiac_persona.core.astronomical import get_motion_type
...
def compute_bhava_drik_bala(chart: RasiChart) -> None:
    ...
    """
    from zodiac_persona.core.constants import NATURAL_BENEFIC_SHADBALA, NATURAL_MALEFIC_SHADBALA
